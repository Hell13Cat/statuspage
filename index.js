...
function getStatusDescriptiveText(color) {
  return color == "nodata"
    ? "Данные недоступны: проверка работоспособности не проводилась."
    : color == "success"
    ? "Сбоев в этот день не зафиксировано."
    : color == "failure"
    ? "Были зафиксированны крупные сбои."
    : color == "partial"
    ? "Были зафиксированны частичные."
    : "Неизвестно";
}
